      ...
      try {
        ...
        if (pkg.scripts) {
          if (pkg.scripts.test) {
            ...
            detectedConfig["test_cmd"] = `${detectedConfig["pkg_manager"]} test`; // ใช้ตัวแปร dynamic
          }
          if (pkg.scripts.build) {
            detectedConfig["run_build"] = true;
            detectedConfig["build_cmd"] = `${detectedConfig["pkg_manager"]} run build`; // ใช้ตัวแปร dynamic
          }
        }
